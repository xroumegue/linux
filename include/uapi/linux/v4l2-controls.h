...
#define V4L2_CID_CCM_CUR			(V4L2_CID_IMAGE_PROC_CLASS_BASE + 6)
#define V4L2_CID_CCM_CUR_LL			(V4L2_CID_IMAGE_PROC_CLASS_BASE + 7)

#define V4L2_CID_BLC_AUTO			(V4L2_CID_IMAGE_PROC_CLASS_BASE + 8)
