			     ...
			     struct v4l2_subdev_state *ifp_state)
{
	...
	ret = mt9m114_read(sensor, MT9M114_CAM_OUTPUT_FORMAT, &output_format);
	if (ret < 0)
		return ret;
	...
	mt9m114_write(sensor, MT9M114_CAM_SENSOR_CONTROL_READ_MODE, read_mode,
		      &ret);
	...
	mt9m114_write(sensor, MT9M114_CAM_OUTPUT_FORMAT, output_format, &ret);
...
static int mt9m114_pa_s_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	case V4L2_CID_HBLANK:
		mt9m114_write(sensor, MT9M114_CAM_SENSOR_CFG_LINE_LENGTH_PCK,
			      ctrl->val + format->width, &ret);
		break;

	case V4L2_CID_VBLANK:
		mt9m114_write(sensor, MT9M114_CAM_SENSOR_CFG_FRAME_LENGTH_LINES,
...
static int mt9m114_probe(struct i2c_client *client)
{
	...
	dev_info(dev, "MT9M114 initialized\n");
